        ...
        fetch(BASE_URL)
            ...
            .then((allProductsRes) => {
                ...
                for (const {
                    ...
                    const buttonsId = createElement('td', tableRow, null, ['btn']);
                    const updateBtn = createElement('button', buttonsId, 'Update', ['update']);
                    const deleteBtn = createElement('button', buttonsId, 'Delete', ['delete']);
